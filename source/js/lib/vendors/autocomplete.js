...
(function (factory) {
    ...
    Autocomplete.prototype = {
        ...
        onKeyPress: function (e) {
            ...
            switch (e.which) {
                case keys.ESC:
                    that.el.val($('<div/>').html(that.currentValue).text());
                    that.hide();
                    break;
                case keys.RIGHT:
        ...
        suggest: function () {
            ...
            if (options.autoSelectFirst) {
                ...
                if (groupBy){
                    container.children().first().next().addClass(classSelected);
                }else{
        ...
        adjustScroll: function (index) {
            ...
            that.el.val($('<div/>').html(that.getValue(that.suggestions[index].value)).text());
            that.signalHint(null);
        },
